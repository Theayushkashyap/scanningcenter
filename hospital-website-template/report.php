...
<body>
    ...
    <div class="container-fluid bg-primary my-5 py-5">
        <div class="container py-5">
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="mb-4">
                        <h5 class="d-inline-block text-white text-uppercase border-bottom border-5">Download Your Report</h5>
                        <h1 class="display-4">Vismaya Scanning center</h1>
                    </div>
                    <p class="text-white mb-5">REPORTS ONLINE ANY TIME, ANY WHERE FROM ANY DEVICE.<br> We are here to provide you with comprehensive and accurate diagnostic services to ensure your well-being. Whether you're visiting us for routine check-ups, specialized screenings, or advanced medical imaging, we strive to deliver exceptional care and accurate results..</p>
                </div>
                <div class="form-container">
        <form action=""method="post">
            <h3>Get Your Report!   <i class="fa fa-1x fa-download text-black "></i></h3>
            <?php 
      if(isset($error)){
      ...
      ?>
            <input type="email" name="email" required placeholder="Enter your ID" >
            <input type="password" name="password" required placeholder="Enter your code">
